...
LOCAL_AWS_TOPIC = "projeto/sensor_status"

# A topic to get information from AWS to the Zolertia board(s):	 
AWS_LOCAL_TOPIC = "refresh/topic"
...
CERT_PEM_FILE = "iot_certs/9d77551f69-certificate.pem.crt"
PRIVATE_KEY_FILE = "iot_certs/9d77551f69-private.pem.key"
